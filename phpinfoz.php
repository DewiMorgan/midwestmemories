<html><head><title>PHP Infoz</title><body>
<?php
...
echo "<p>method_exists('mysqli_stmt::get_result')? -> " . (method_exists('mysqli_stmt', 'get_result') ? "exists":"not found") . "</p>\n";
echo "<p>function_exists('mysqli_stmt_get_result')? -> " . (function_exists('mysqli_stmt_get_result') ? "exists":"not found") . "</p>\n";
